...
export default function CreateProgramTypeModal({ onClose }) {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      await api.post(`${GlobalConfig.apiUrl}/v1/program-types`, data);
      alert("Program type created successfully!");
      reset();
      onClose(true);
    } catch (error) {
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        <h2 className="font-bold text-lg">Create Program Type</h2>
