...
export default function EditProgramTypeModal({ programType, onClose }) {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      await api.put(
        `${GlobalConfig.apiUrl}/v1/program-types/${programType.id}`,
        data
      );
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        <h2 className="text-lg font-bold">Edit Program Type</h2>
