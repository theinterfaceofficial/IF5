...
export default function EditExpenseTypeModal({ expenseType, onClose }) {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      await api.put(
        `${GlobalConfig.apiUrl}/v1/expense-types/${expenseType.id}`,
        data
      );
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        <h2 className="text-lg font-bold">Edit Expense Type</h2>
