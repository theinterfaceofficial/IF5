...
const createImmigrationClientSchema = z.object({
...
export default function CreateImmigrationClientModal({ onClose }) {
  ...
  const {
    ...
    resolver: zodResolver(createImmigrationClientSchema),
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await api.post(`${GlobalConfig.apiUrl}/v1/immigration-clients`, data);
      alert("Immigration client created successfully!");
      reset();
      onClose(true);
    } catch (error) {
      ...
      if (serverErrors) {
        ...
        console.error("Error creating immigration client:", error);
