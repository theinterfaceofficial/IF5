...
export default function CreateDocumentTypeModal({ onClose }) {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      await api.post(`${GlobalConfig.apiUrl}/v1/document-types`, data);
  ...
  return (
    <Modal onClose={onClose}>
      ...
      >
        <h2 className="font-bold text-lg">Create Document Type</h2>
